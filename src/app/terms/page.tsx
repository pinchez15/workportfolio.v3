  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-4xl font-black text-neutral-900 mb-8">Terms of Service</h1>
        
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Use License</h2>
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">User Content</h2>
            <p className="text-slate-600 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Prohibited Uses</h2>
            <p className="text-slate-600 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Service Availability</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Limitation of Liability</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Privacy</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Termination</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Changes to Terms</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Contact Information</h2>
            <p className="text-slate-600">
